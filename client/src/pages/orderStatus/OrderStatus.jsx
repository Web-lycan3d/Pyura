          ...
          {OrderStatus ? (
            <>
              <p>
                ...
                through a text message, enter the same OTP into the second box.
                Once you have successfully entered your OTP, you will then be
                able to <span>view the status</span> of your order.
              </p>
              <div className="order-s-form">
                <form onSubmit={handleSubmit}>
                  ...
                  {phoneNorErr && <span className="error-msg">Not Valid!</span>}
                  {OTPsent && (
                    <>
                      <span className="error-msg">OTP sent to {phoneNo} </span>
              ...
              <div className="order-s-bottom">
                ...
                <span>
                  ...
                  page and give us a ring or write to us, we'll get back shortly
                  and help you out.
                </span>
              </div>
            </>
